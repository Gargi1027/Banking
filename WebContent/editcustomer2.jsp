                        ...
                        <div class="art-content-layout-row">
                                        ...
                                        <div class="art-vmenublockcontent">
                                            <div class="art-vmenublockcontent-body">
                                                <ul class="art-vmenu">
                                                    ...
                                                    <li>
                                                        <a href="editcustomer1.jsp" class="active"><span class="l"></span><span class="r"></span><span class="t">Edit Customer</span></a>
                                                    </li>
                                                    <li>
                            ...
                            <div class=" art-content">
                                <div class="art-post">
                                    ...
                                    <br></br>
                                    <form method="post" action="editcustomer3.jsp">
                                            <center>
                                                <%
                                                    String custId = request.getParameter("custId");

                                                    BankClient bankClient = new BankClient();
                                                    Customer customer = bankClient.findCustomer(custId);
