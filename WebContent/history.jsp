                                        ...
                                        <div class="art-vmenublockcontent">
                                            <div class="art-vmenublockcontent-body">
                                                <ul class="art-vmenu">
                                                    ...
                                                    <li>
                                                        <a href="history.jsp" class="active"><span class="l"></span><span class="r"></span><span class="t">Show Transaction History</span></a>
                                                    </li>
                                                    <li>
                                ...
                                <div class="art-post">
                                    ...
                                    <form method="post" action="addcustomer2.jsp">
                                            <center>
                                                ...
                                                %>
                                                <table    border="1" width="70%" cellpadding="3"  class="formfont" align="center" >
