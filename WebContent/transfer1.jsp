                        ...
                        <div class="art-content-layout-row">
                                        ...
                                        <div class="art-vmenublockcontent">
                                            <div class="art-vmenublockcontent-body">
                                                <ul class="art-vmenu">
                                                    ...
                                                    <li>
                                                        <a href="transfer1.jsp" class="active"><span class="l"></span><span class="r"></span><span class="t">Transfer Amount</span></a>
                            ...
                            <div class=" art-content">
                                <div class="art-post">
                                    ...
                                    <br></br>
                                    <form method="post" action="transfer2.jsp">
                                            <center>
                                                <%
                                                ...
                                                <table  width="70%" cellpadding="3" border="1">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="30%"> Select Customer 1</td>
                                                            <td>
                                                                <select name="custId1">
                                                                    <%
                                                                        if (customers != null) {
                                                        ...
                                                        <tr>
                                                            <td width="30%"> Select Customer 2</td>
                                                            <td>
                                                                <select name="custId2">
                                                                    <%
                                                                        if (customers != null) {
