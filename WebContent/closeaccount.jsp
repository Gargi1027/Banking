                        ...
                        <div class="art-content-layout-row">
                                    ...
                                    <div class="art-vmenublock-body">
                                        <div class="art-vmenublockcontent">
                                            <div class="art-vmenublockcontent-body">
                                                <ul class="art-vmenu">
                                                    <li>
                                                        <a href="addcustomer1.jsp" ><span class="l"></span><span class="r"></span><span class="t">Add Customer</span></a>
                                                    </li>	
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="closeaccount.jsp" class="active"><span class="l"></span><span class="r"></span><span class="t">Close Account</span></a>
                                                    </li>
                                                    <li>
                            ...
                            <div class=" art-content">
                                <div class="art-post">
                                    ...
                                    <br></br>
                                    <form method="post" action="closeaccount2.jsp">
                                        <center>
                                            <%
                                            ...
                                            <table  width="70%" cellpadding="3" border="1">
                                                <thead>
                                                    <tr >
                                                        <th colspan="2">Close Account</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td width="30%"> Select Customer</td>
                                                        <td>
                                                            <select name="custId">
                                                                <%
                                                                    if (customers != null) {
